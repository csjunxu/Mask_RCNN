...
def save_instances(image, boxes, masks, class_ids, class_names,
    ...
    for i in range(N):
        ...
        cv2.putText(masked_image, caption,(x1,y1+8), font, 1, (255,155,155),2, cv2.LINE_AA)
...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    fig.savefig(os.path.join('./home/csjunxu/Project/sliced_mask_JX', title))

    if auto_show:
        plt.savefig(os.path.join('./home/csjunxu/Project/sliced_mask_JX', title))
        # plt.show()
